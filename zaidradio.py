...
HELP =""" ᴄᴜʀʀᴇɴᴛʟʏ ꜱᴜᴘᴘᴏʀᴛᴇᴅ ꜱᴛᴀᴛɪᴏɴꜱ:
...
ᴛᴏ ꜱᴛᴀʀᴛ ʀᴇᴘʟᴀʏ ᴛᴏ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪᴛʜ ᴄᴏᴍᴍᴀɴᴅ !radio <Station Number> ʟɪᴋᴇ /ʀᴀᴅɪᴏ 1
ᴛᴏ ᴇɴᴅ and ꜱᴛᴏᴘ ꜱᴛʀᴇᴀᴍ by!stop ᴄᴏᴍᴍᴀɴᴅ. ꜱᴜᴘᴘᴏʀᴛ? @Zaid_Support"""
...
async def start(client,message):
	...
	await message.reply_text(f'ᴢᴀɪᴅ #{station_id} ꜱᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ ᴜʀ ᴄʜᴏᴏꜱᴇɴ ꜱᴛᴀᴛɪᴏɴ.')
